      ...
      children: [
        ...
        SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "${transaction!.quantity} item(s) • ${NumberFormat.currency(symbol: 'IDR ', decimalDigits: 0, locale: 'id-ID').format(transaction!.total)}",
        ...
        SizedBox(
          ...
          child: Column(
            ...
            children: [
              Text(
                convertDateTime(transaction?.dateTime ?? DateTime.now()),
